...
// Pano2VR 6.0.2/17253
// Filename: my_skin_SPUTNIK-2.ggsk
// Generated Ср май 15 14:22:41 2019
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._map_1__mapdiv.setAttribute('style','position: absolute; left: 50%; margin-left: -' + me._map_1.ggFloorplanWidth / 2 + 'px; bottom: 0px;width:' + me._map_1.ggFloorplanWidth + 'px;height:' + me._map_1.ggFloorplanHeight + 'px;overflow:hidden;;');
		...
		me._map_1.ggInitMapMarkers=function() {
			...
			for(var i=0; i < ids.length; i++) {
				...
				if (coords.length>=2) {
					...
					me._map_1.ggVMarkerAnchorOffset = 19;
					var markerParent = new Object();
					markerParent.ggElementNodeId=function() { return id };
					var markerClass = new SkinElement_pin_white_Class(me, markerParent);
					me._map_1.ggMarkerInstances.push(markerClass);
					var marker = markerClass._pin_white;
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs=basePath + 'images/ht_node_visited.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_button';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		hs=basePath + 'images/ht_node_visited__o.png';
	...
	function SkinElement_pin_white_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		me.parentScope=parentScope;
		...
		el=me._pin_white=document.createElement('div');
		els=me._pin_white__img=document.createElement('img');
		els.className='ggskin ggskin_pin_white';
		hs=basePath + 'images/pin_white.png';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._pin_white.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return me.ggNodeId;
		}
		me._pin_white.onclick=function (e) {
			player.openNext("{"+me.ggNodeId+"}","");
		}
		me._pin_white.ggUpdatePosition=function (useTransition) {
		}
	};
	me.addSkin();
